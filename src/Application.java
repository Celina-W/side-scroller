 ...
 * 
 * Celina Wu: Setting up the game timer, animating all of the sprites in accordance with the timer, creating the sprite updater and 
 * obstacle spawner action listeners, drawing the background by hand, creating the score counter, condensing a lot of the code, 
 * contributing to the javadoc
 * 
